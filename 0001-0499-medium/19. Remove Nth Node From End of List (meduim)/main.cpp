...
int main() {
  {
    auto l_7 = ListNode(7);
    auto l_6 = ListNode(6, &l_7);
    auto l_5 = ListNode(5, &l_6);
    auto l_4 = ListNode(4, &l_5);
    auto l_3 = ListNode(3, &l_4);
    auto l_2 = ListNode(2, &l_3);
    auto l_1 = ListNode(1, &l_2);

    const std::vector<int> expected_values{1,2,3,4,5,7};
    auto actual = Solution::removeNthFromEnd(&l_1, 2);
  ...
  }
  {
    ...
    const std::vector<int> expected_values{1,2,3,4,5,6};
    auto actual = Solution::removeNthFromEnd(&l_1, 1);
    checkAssertion(actual, expected_values);
  }
  {
    auto l_7 = ListNode(7);
    ...
    const std::vector<int> expected_values{1,3,4,5,6,7};
    auto actual = Solution::removeNthFromEnd(&l_1, 6);
    checkAssertion(actual, expected_values);
  }
  {
    auto l_7 = ListNode(7);
    ...
    const std::vector<int> expected_values{2,3,4,5,6,7};
    auto actual = Solution::removeNthFromEnd(&l_1, 7);
    checkAssertion(actual, expected_values);
  }
  {
    auto l_2 = ListNode(2);
